...
export default function CreateProfile() {
  ...
  // Edit mode is active only when the currently logged-in user
  // already has profile details filled in.
  ...
  // Saves the profile and routes to the correct next page.
  const handleSubmit = () => {
  ...
  // Back navigation depends on whether the user edits or creates a profile.
  const handleBack = () => {
