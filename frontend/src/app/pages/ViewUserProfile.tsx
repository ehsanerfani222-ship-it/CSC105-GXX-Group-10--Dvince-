...
// Shape of incoming router state from the search page.
...
export default function ViewUserProfile() {
  ...
  // Read navigation state so we can return to the search page
  // with the exact same search/filter values.
  const navigationState = (location.state as UserProfileLocationState | null) ?? null;

  const handleBack = () => {
    navigate(navigationState?.from || '/search', {
      state: {
