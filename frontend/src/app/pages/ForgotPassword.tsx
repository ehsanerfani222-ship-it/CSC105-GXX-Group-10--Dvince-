...
if (!res.ok) {
  ...
  setStatusMessage(data.message || 'Reset link generated.');
  setDevResetLink(data.link || '');
  setIsSubmitted(true);
}
} catch (err) {
  console.error(err);
          ...
          {!isSubmitted ? (
            ...
            <>
              ...
              <div className="text-center">
                ...
                {devResetLink && (
                  <div className="bg-cyan-50 border border-cyan-100 rounded-lg p-4 mt-5 text-left">
                    ...
                    <button
                      ...
                      className="text-sm text-cyan-700 hover:underline break-all text-left"
                    >
                      {devResetLink}
                    </button>
                  </div>
